  ...
  <section class="all">
    ...
    <div class="carousel">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <h2>عنوان السلايد الاول</h2>
                <p>قال البزون للكلب زربة عليك</p>
                <!-- <a href="#" class="carousel-btn">تريد تشوف ؟</a> -->
            </div>
        </div>
    ...
    <div class="section-title">
        <h3 class="slider-title">قطع جديدة</h3>
    </div>
    ...
    <!-- Horizontally Scrollable Cards Section -->
    <div class="section-title">
        <h3 class="slider-title">عروض حصرية</h3>
    </div>
    ...
    <div class="section-title">
        <h3 class="slider-title">نوتات رائعة</h3>
    </div>
